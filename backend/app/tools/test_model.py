...
def model_url(source,model_id):
    ...
    patterns={"printables":f"https://www.printables.com/model/{model_id}","makerworld":f"https://makerworld.com/en/models/{model_id}","thingiverse":f"https://www.thingiverse.com/thing:{model_id}","grabcad":f"https://grabcad.com/library/{model_id}"}
